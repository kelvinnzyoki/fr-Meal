  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      ...
      <div className="mt-6 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
        <div className="flex items-center justify-center border-2 border-ink/10 rounded-card self-start sm:self-auto">
        ...
        <button
          ...
          disabled={adding}
          className="flex-1 bg-marigold text-ink font-bold py-3 px-3 rounded-card hover:bg-marigoldDark transition-colors disabled:opacity-60"
        >
